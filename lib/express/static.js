...
/*
 * Dynamic page mapped to /exit
 */
async function exit (req, res) {
    let params = {message: 'Kill it!'};
    log.debug(`Sending suicide response with params: ${JSON.stringify(params)}`);
    res.send(params);
    process.exit(0);
}
...
export { guineaPig, guineaPigScrollable, welcome, exit, STATIC_DIR };
