...
commands.createSession = async function (jsonwpDesiredCapabilities, jsonwpRequiredCaps, w3cCapabilities) { // eslint-disable-line require-await
  ...
  if (this.shouldValidateCaps) {  this.validateDesiredCaps(caps); }
...
commands.getSessions = async function () { // eslint-disable-line require-await
  let ret = [];
...
commands.getSession = async function () { // eslint-disable-line require-await
...
commands.deleteSession = async function (/* sessionId */) { // eslint-disable-line require-await
