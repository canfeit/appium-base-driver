...
testwa.getActionAndroid = async function(driver,req,httpStatus,httpResBody,command,jsonObj){
    ...
    let [action,param] = this.getTranslationAction(command,jsonObj);
